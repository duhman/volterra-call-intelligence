      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Automatic call transcription and HubSpot sync. Save 15+ minutes per
            call with GDPR-compliant AI summaries.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  PBX webhook triggers recording lookup automatically
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Slack message sent to sales rep for GDPR-compliant approval
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  ElevenLabs converts audio to text with speaker identification
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  GPT-4 generates structured summary with sentiment, next steps,
                  and key points
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Automatically attached to contact record with full transcript
                  and summary
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Capture pricing discussions, objections, and commitments
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Document requirements, pain points, and decision makers
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Track promises made and agreed next steps
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Review call patterns and improve sales technique
                </p>
              </div>
            </div>
          </div>
