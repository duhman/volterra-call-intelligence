    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure Slack credentials and map telephony agents to Slack users
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="border-t pt-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Map PBX agent_user_id to a Slack user ID (e.g. U12345678).
            </p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>PBX Webhook URL</CardTitle>
          <CardDescription>
            Use this URL in your PBX provider webhook configuration to receive
            call events. Make sure to enable the &quot;answer&quot;,
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4">
            <h4 className="font-medium mb-2">PBX Setup Instructions</h4>
            <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
              <li>Go to your PBX admin portal</li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test the PBX API connection and inspect the response to diagnose
            recording issues.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
              ...
              {debugData.status === 404 ? (
                <div className="rounded-lg border border-amber-500/50 bg-amber-500/10 p-4 space-y-2">
                  <h4 className="font-medium flex items-center gap-2 text-amber-600">
                    ...
                    No PBX Organization Configured
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    {debugData.details ||
                      "No PBX organization configuration found. Add a PBX access token to enable the debug API."}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    To configure, add a PBX access token environment variable or
                    create an organization config in the database.
                  </p>
                </div>
              ) : (
                <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage PBX API keys per sales agent. Each agent needs their own API
            key to fetch their call recordings.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {isKeysLoading ? (
                ...
                <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
                  ...
                  <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="api-key">PBX API Key</Label>
                        <Input
                          id="api-key"
                          type="password"
                          placeholder="Enter the agent's PBX API key"
                          value={newApiKey}
                          onChange={(e) => setNewApiKey(e.target.value)}
                        />
                        <p className="text-xs text-muted-foreground">
                          Get this from your PBX portal → User Settings → API
                          Keys
                        </p>
                      </div>
                      <div className="space-y-2">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border">
              <div>
                <p className="font-medium">Default PBX API Key</p>
                <p className="text-sm text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex items-center justify-between p-4 rounded-lg border">
              <div>
                <p className="font-medium">PBX Provider</p>
                <p className="text-sm text-muted-foreground">
